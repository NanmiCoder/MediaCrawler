...
Before external tests were isolated, the full observed baseline was:
...
collected, but six Redis/proxy failures are skipped unless their environment is
explicitly enabled:
...
1. T021-2: align Redis configuration.
2. T021-3: reconcile the legacy crawler route contract.
3. T021-4: align health response fields.
4. T021-5: repair test shutdown and logging lifecycle.
